					...
					<c:forEach items="${list}" var="data">
						<tr class="row100 body">
							<td scope="col" class="text-center"><img class="img-fluid rounded mb-4 mb-lg-0" 
												                src="../resources/uploadproduct/${data.fileName}" alt="..." 
												                  width="60" height="60"	/></td>
							<td scope="col" class="text-center"><a href="./proSelect?proNum=${data.proNum}">${data.proNum}</a></td>
							<td scope="col" class="text-center">${data.userId}</td>
							<td scope="col" class="text-center"><a href="./proSelect?proNum=${data.proNum}">${data.proName}</a></td>
							<td scope="col" class="text-center">${data.proCategory}</td>
							<td scope="col" class="text-center">${data.proInfo}</td>
							<td scope="col" class="text-center">${data.proPrice}</td>
						</tr>
					</c:forEach>
				</tbody>
				</table>
