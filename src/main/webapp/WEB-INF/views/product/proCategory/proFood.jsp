				...
				<table class="table table-hover">
					...
					<c:forEach items="${food}" var="food">
						<tr class="row100 body">
							...
							<td scope="col" class="text-center"><a href="./proSelect?proNum=${food.proNum}">${food.proNum}</a></td>
							<!-- 상품 등록한 유저 아이디 -->
							<td scope="col" class="text-center">${food.userId}</td>
							<!-- 상품 이름 링크로 해당번호 상품 이동가능 -->
							<td scope="col" class="text-center"><a href="./proSelect?proNum=${food.proNum}">${food.proName}</a></td>
							<!-- 상품 카테고리 -->
